...
// - these are simple convenience functions to draw primitives in openGL
...
// draw a triangle between three specified points, it draws from p0-p1-p2 in this order
